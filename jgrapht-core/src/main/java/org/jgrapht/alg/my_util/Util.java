...
public class Util {
    ...
    public static final String PLANAR_GRAPH_PATH = "C:\\Users\\timof\\Documents\\stuff\\GSoC_2018\\Tmp\\planar\\graph.txt";

    public static Graph<Integer, DefaultEdge> readGraph(String path) {
    ...
    public static Graph<Integer, DefaultEdge> readGraph(){
        return readGraph(PLANAR_GRAPH_PATH);
    }
    ...
    public static<V, E> void exportSimple(Graph<V, E> graph, boolean weighted) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(new File(EDGE_LIST_PATH)))) {
            ...
            for (E edge : graph.edgeSet()) {
                ...
                writer.write(a.toString() + " " + b.toString());
                if (weighted) {
                    writer.write(" " + weight);
                }
                writer.write("\n");
